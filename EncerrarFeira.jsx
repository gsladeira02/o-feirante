...
.action-card span, .action-card small {
  opacity: .9;
}
...
.item-card, .history-card, .close-card {
  background: #fff;
  border: 1px solid var(--line);
  border-radius: 22px;
  padding: 16px;
...
.item-card strong, .history-card strong, .close-card strong {
  font-size: 17px;
}

.item-card span, .history-card span, .close-card span {
  color: var(--muted);
  font-size: 14px;
}
